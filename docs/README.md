...
| | Opis |
|---|---|
| ![Architektura](assets/architecture-overview.png) | Przegląd całego systemu |
| ![GitOps](assets/gitops-flow.png) | Przepływ wdrożenia |
| ![App-of-Apps](assets/app-of-apps.png) | Wzorzec zarządzania aplikacjami |
| ![Sieć](assets/network-layer.png) | Routing HTTP lokalnie |
